...
public class HDFS_Upload {
    public static void main(String[] args) throws IOException, URISyntaxException, InterruptedException {
        ...
        FileSystem filesystem = FileSystem.get(new URI("hdfs://cdh101:8020"), configuration, "root"); //配置在集群上运行   //core-site.xml中<name>fs.defaultFS</name>   <value>hdfs://hadoop:9000</value>  代表端口9000
