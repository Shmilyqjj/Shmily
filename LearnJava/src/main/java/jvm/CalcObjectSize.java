...
/**
 * 计算对象大小(字节)
 * 大概计算对象大小，当一个对象引用String类型时，是有常量池的存在的，所以计算出来的只我们只能做个参考即可。
 * 仅支持JDK8
 */
...
//        ClassInspector.ObjectInfo oInfo1 = inspector.introspect(arr);
//        System.out.println(oInfo1.getDeepSize());
//        ClassInspector.ObjectInfo oInfo2 = inspector.introspect(2);
//        System.out.println(oInfo2.getDeepSize());
