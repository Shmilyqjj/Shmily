...
//        faceObjects.SortCosmeticManager sc = new faceObjects.SortCosmeticManager();
//        sc.Add(new faceObjects.Cosmetic("雅诗兰黛","进口",1000));
//        sc.Add(new faceObjects.Cosmetic("香奈儿","进口",800));
//        sc.Add(new faceObjects.Cosmetic("大宝","国产",20));
//        sc.Add(new faceObjects.Cosmetic("郁美净","国产",5));
//        sc.show();
...
class SortCosmeticManager extends CosmeticManager{
    public void show(){
//        faceObjects.Cosmetic[] cs = new faceObjects.Cosmetic[5];
